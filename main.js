...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const projectDetails = [
        ...
        { title: 'Immersive Enchanting', description: PLACEHOLDER_DESCRIPTION, image: './images/immersiveEnchantingForkIcon.png', imageAlt: 'Immersive Enchanting fork icon' },
        { title: 'Catenna', description: PLACEHOLDER_DESCRIPTION, image: './images/catennaPlaceholder.svg', imageAlt: 'Catenna placeholder icon' },
        { title: 'Minecraft Mod Development', description: PLACEHOLDER_DESCRIPTION, image: './images/forgeIcon.png', imageAlt: 'Minecraft Forge icon' },
        { title: 'SI Leader - California State University, East Bay', description: PLACEHOLDER_DESCRIPTION, image: './images/scaaIcon.png', imageAlt: 'SCAA icon' }
    ];
